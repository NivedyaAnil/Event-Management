...
<!--get-->
        ...
        <% 
            ...
            if(submit!=null)
            {
                ...
                ps1.setString(4,dn);
                ps1.setString(5,decoration+"");
                ps1.setString(6,lsn);
                ps1.setString(7,lightsound+"");
                ps1.setString(8,cvn);
                ps1.setString(9,cameravideo+"");
                ps1.setString(10,catn);
                ps1.setString(11,catering+"");
                ps1.setString(12,cn);
                ps1.setString(13,cake+"");
                ps1.setString(14,mn);
                ps1.setString(15,makeup+"");
                ps1.setString(16,carn);
                ps1.setString(17,car+"");
                ps1.setString(18,hn);
               ...
               ps2.setString(1,name);
                ...
                ps2.setString(4,dn);
                ps2.setString(5,decoration+"");
                ps2.setString(6,lsn);
                ps2.setString(7,lightsound+"");
                ps2.setString(8,cvn);
                ps2.setString(9,cameravideo+"");
                ps2.setString(10,catn);
                ps2.setString(11,catering+"");
                ps2.setString(12,cn);
               ...
               ps3.setString(9,dj+"");
                ...
                ps4.setString(2,sn);
                ps4.setString(3,stage+"");
                ps4.setString(4,dn);
                ps4.setString(5,decoration+"");
                ps4.setString(6,lsn);
                ps4.setString(7,lightsound+"");
                ps4.setString(8,djn);
                ps4.setString(9,dj+"");
                ps4.setString(10,ln);
